...
##	univariate polynomial over power series generated by this package which 
##	have the same main variable, power series generated by this package or polynomials
##
##DESCRIPTION
...
##> s1 + f;
##<(verification="type") object
##- We get an error if we try to add _s1_ and _s3_, since the orders [x,y] and [y,x] are 
##	not compatible.
##> s1 + s3;
