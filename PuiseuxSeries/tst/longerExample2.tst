...
Try[testnoerror]("test 2.1", PuSO:-BinaryMultiply(puso1, puso2), 'assign'='pusMult');
Try("test 2.2", PuSO:-Truncate(pusMult, 40), 1);
...
Try[testnoerror]("test 9.1", PuSO:-BinaryMultiply(puso4, puso5), 'assign'='pusMult');
Try("test 9.2", PuSO:-Truncate(pusMult, 40), 1);

Try[testnoerror]("test 10", PuSO:-BinaryMultiply(pusoNegOne, puso3), 'assign'='dummy3');

Try[testnoerror]("test 11", PuSO:-BinaryAdd(puso1, dummy3), 'assign'='dummy4');

Try[testnoerror]("test 12", PuSO:-BinaryMultiply(puso2, dummy4), 'assign'='dummy5');

Try[testnoerror]("test 13", PuSO:-BinaryMultiply(puso5, dummy5), 'assign'='puso_final');

Try("test 14", PuSO:-Truncate(puso_final, 1000), 1);
