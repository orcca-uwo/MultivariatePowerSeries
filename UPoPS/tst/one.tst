...
Try("test 5", UPoPSObject:-ApproximatelyEqual(upOne, UPoPSObject:-Zero()), false);
Try("test 6", UPoPSObject:-ApproximatelyEqual(upOne, upOne), true);
...
Try("test 11", ApproximatelyEqual(upOne, UnivariatePolynomialOverPowerSeries(0)), false);
Try("test 12", ApproximatelyEqual(upOne, upOne), true);
