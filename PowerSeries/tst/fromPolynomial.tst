...
Try("test 1", PSO:-ApproximatelyZero(psP, 'force'), true);
Try("test 2", PSO:-ApproximatelyEqual(psP, PSO:-One(), 'force'), false);
Try("test 4", PSO:-ApproximatelyEqual(psP, psP, ':-force'), true);
...
Try("test 10", PSO:-ApproximatelyZero(psP, 'force'), false);
Try("test 11", PSO:-ApproximatelyEqual(psP, PSO:-One(), 'force'), true);
Try("test 12", PSO:-ApproximatelyEqual(psP, psP, ':-force'), true);
...
Try("test 18", PSO:-ApproximatelyZero(psP, 'force'), false);
Try("test 19", PSO:-IsUnit(psP), true);
Try("test 20", PSO:-ApproximatelyEqual(psP, PSO:-One(), 'force'), false);
Try("test 21", PSO:-ApproximatelyEqual(psP, psP, ':-force'), true);
...
Try("test 31", PSO:-ApproximatelyZero(psQ, 'force'), false);
Try("test 32", PSO:-IsUnit(psQ), true);
Try("test 33", PSO:-ApproximatelyEqual(psQ, PSO:-One(), 'force'), false);
Try("test 34", PSO:-ApproximatelyEqual(psQ, psP, 1, ':-force'), true);
Try("test 35", PSO:-ApproximatelyEqual(psQ, psP, ':-force'), false);
Try("test 36", PSO:-ApproximatelyEqual(psQ, psQ, ':-force'), true);
...
Try("test 44", ApproximatelyZero(psP, 'force'), true);
Try("test 45", ApproximatelyEqual(psP, PowerSeries(1), ':-force'), false);
Try("test 46", ApproximatelyEqual(psP, psP, ':-force'), true);
...
Try("test 52", ApproximatelyZero(psP, 'force'), false);
Try("test 53", ApproximatelyEqual(psP, PowerSeries(1), ':-force'), true);
Try("test 54", ApproximatelyEqual(psP, psP, ':-force'), true);
...
Try("test 60", ApproximatelyZero(psP, 'force'), false);
Try("test 61", IsUnit(psP), true);
Try("test 62", ApproximatelyEqual(psP, PowerSeries(1), ':-force'), false);
Try("test 63", ApproximatelyEqual(psP, psP, ':-force'), true);
...
Try("test 73", ApproximatelyZero(psQ, 'force'), false);
Try("test 74", IsUnit(psQ), true);
Try("test 75", ApproximatelyEqual(psQ, PowerSeries(1), ':-force'), false);
Try("test 76", ApproximatelyEqual(psQ, psP, 1, ':-force'), true);
Try("test 77", ApproximatelyEqual(psQ, psP, ':-force'), false);
Try("test 78", ApproximatelyEqual(psQ, psQ, ':-force'), true);
