...
Try("test 2", PSO:-ApproximatelyZero(psSAM), false);
Try("test 3", PSO:-IsUnit(psSAM), true);
Try("test 4", PSO:-ApproximatelyEqual(psSAM, psSAM), true);
Try("test 5", PSO:-ApproximatelyEqual(psSAM, PSO:-GeometricSeries([x, y])), true);
...
Try("test 12", ApproximatelyZero(psSAM), false);
Try("test 13", IsUnit(psSAM), true);
Try("test 14", ApproximatelyEqual(psSAM, psSAM), true);
Try("test 15", ApproximatelyEqual(psSAM, GeometricSeries([x, y])), true);
