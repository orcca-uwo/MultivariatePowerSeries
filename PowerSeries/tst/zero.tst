...
Try("test 2", PSO:-ApproximatelyZero(psZero, 'force'), true);
Try("test 3", PSO:-IsUnit(psZero), false);
Try("test 4", PSO:-ApproximatelyEqual(psZero, psZero, ':-force'), true);
...
Try("test 10", ApproximatelyZero(psZero, 'force'), true);
Try("test 11", IsUnit(psZero), false);
Try("test 12", ApproximatelyEqual(psZero, psZero, ':-force'), true);
...
Try("test 17", ApproximatelyEqual( Subtract(PowerSeries(1 + x^2), PowerSeries(1 + x^2)), psZero, ':-force'), true);
Try("test 18", ApproximatelyEqual( Add(PowerSeries(0), PowerSeries(0), PowerSeries(0)), psZero, ':-force'), true);
Try("test 19", ApproximatelyEqual( Multiply(PowerSeries(0), SumOfAllMonomials([x]), GeometricSeries([x, y])), psZero, ':-force'), true);
