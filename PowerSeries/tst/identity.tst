...
Try("test 2", PSO:-ApproximatelyZero(psI, 'force'), false);
Try("test 3", PSO:-IsUnit(psI), false);
Try("test 4", PSO:-ApproximatelyEqual(psI, PSO:-Zero(), 0, ':-force'), true);
Try("test 5", PSO:-ApproximatelyEqual(psI, PSO:-Zero(), 'force'), false);
Try("test 6", PSO:-ApproximatelyEqual(psI, PSO:-One(), 'force'), false);
Try("test 7", PSO:-ApproximatelyEqual(psI, psI, ':-force'), true);
...
Try("test 15", ApproximatelyZero(psI, 'force'), false);
Try("test 16", IsUnit(psI), false);
Try("test 17", ApproximatelyEqual(psI, PowerSeries(0), 0, ':-force'), true);
Try("test 18", ApproximatelyEqual(psI, PowerSeries(0), ':-force'), false);
Try("test 19", ApproximatelyEqual(psI, PowerSeries(1), ':-force'), false);
Try("test 20", ApproximatelyEqual(psI, psI, ':-force'), true);
