...
Try("test 2", PSO:-ApproximatelyZero(psConst, 'force'), true);
Try("test 3", PSO:-ApproximatelyEqual(psConst, PSO:-Zero(), 'force'), true);
Try("test 4", PSO:-ApproximatelyEqual(psConst, PSO:-One(), 'force'), false);
Try("test 5", PSO:-ApproximatelyEqual(psConst, PSO:-Identity(x), ':-force'), false);

Try[testnoerror]("test 6", PSO:-Constant(1), 'assign'='psConst');
Try("test 7", PSO:-ApproximatelyZero(psConst, 'force'), false);
Try("test 8", PSO:-IsUnit(psConst), true);
Try("test 9", PSO:-ApproximatelyEqual(psConst, PSO:-Zero(), 'force'), false);
Try("test 10", PSO:-ApproximatelyEqual(psConst, PSO:-One(), 'force'), true);
Try("test 11", PSO:-ApproximatelyEqual(psConst, PSO:-Identity(x), ':-force'), false);
Try("test 12", PSO:-ApproximatelyEqual(psConst, psConst, ':-force'), true);
...
Try("test 27",  ApproximatelyZero(psConst, 'force'), true);
Try("test 28",  ApproximatelyEqual(psConst,  PowerSeries(0), ':-force'), true);
Try("test 29",  ApproximatelyEqual(psConst,  PowerSeries(1), ':-force'), false);
Try("test 30",  ApproximatelyEqual(psConst,  PowerSeries(x), ':-force'), false);

Try[testnoerror]("test 31",   PowerSeries(1), 'assign'='psConst');
Try("test 32",  ApproximatelyZero(psConst, 'force'), false);
Try("test 33",  IsUnit(psConst), true);
Try("test 33",  ApproximatelyEqual(psConst,  PowerSeries(0), ':-force'), false);
Try("test 34",  ApproximatelyEqual(psConst,  PowerSeries(1), ':-force'), true);
Try("test 35",  ApproximatelyEqual(psConst,  PowerSeries(x), ':-force'), false);
Try("test 36",  ApproximatelyEqual(psConst, psConst, ':-force'), true);
